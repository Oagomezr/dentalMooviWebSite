...
class ProductsSerIntegrationTest {
    ...
    void getProductsByCategoryTest(){
        List<Categories> parentsCategories = categoriesRep.findByParentCategoryIsNullOrderByName();
    ...
    void getProductsByContainingTest(){
        ...
        keyWords.stream().forEach(keyWord ->{
            List<Products> products7Found = productsRep.findTop7ByNameContainingIgnoreCase(keyWord);
            List<Products> productsFound = productsRep.findByNameContainingIgnoreCase(keyWord);
