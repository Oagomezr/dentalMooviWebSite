...
public class InitialTestData {
    ...
    public void init(){
        ...
        Products adhesivo1 = Utils.setProduct("Adhesivo1", "description adhesivo1", "descripción corta", 13000,4, adhesivos.getId(), true, productsRep);
        Products adhesivo2 = Utils.setProduct("Adhesivo2", "description adhesivo2", "descripción corta", 13000,4, adhesivos.getId(), false, productsRep);
        Products alambre1 = Utils.setProduct("Alambre1", "description alambre1", "descripción corta", 13000,4, alambres.getId(), true, productsRep);
        Products alambre2 = Utils.setProduct("Alambre2", "description alambre2", "descripción corta", 13000,4, alambres.getId(), true, productsRep);
        Products arco1 = Utils.setProduct("Arco1", "description arco1", "descripción corta", 13000,4, arcos.getId(), true, productsRep);
        Products arco2 = Utils.setProduct("Arco2", "description arco2", "descripción corta", 13000,4, arcos.getId(), true, productsRep);
        Products auxiliar1 = Utils.setProduct("Auxiliar1", "description Auxiliar1", "descripción corta", 13000,4, auxiliares.getId(), true, productsRep);
        Products auxiliar2 = Utils.setProduct("auxiliar2", "description auxiliar2", "descripción corta", 13000,4, auxiliares.getId(), true, productsRep);
        Products bisacrilico1 = Utils.setProduct("bisacrilico1", "description bisacrilico1", "descripción corta", 13000,4, bisacrilicos.getId(), true, productsRep);
        Products bisacrilico2 = Utils.setProduct("bisacrilico2", "description bisacrilico2", "descripción corta", 13000,4, bisacrilicos.getId(), true, productsRep);
        Products carrierBraket1 = Utils.setProduct("carrierBraket1", "description carrierBraket1", "descripción corta", 13000,4, brakets.getId(), true, productsRep);
        Products cemento1 = Utils.setProduct("cemento1", "description cemento1", "descripción corta", 13000,4, cemento.getId(), true, productsRep);
        Products cepilloOral = Utils.setProduct("cepilloOral", "description cepilloOral", "descripción corta", 13000,4, cuidadoDental.getId(), true, productsRep);
        Products compomero1 = Utils.setProduct("compomero1", "description compomero1", "descripción corta", 13000,4, compomeros.getId(), true, productsRep);
        Products compomero2 = Utils.setProduct("compomero2", "description compomero2", "descripción corta", 13000,4, compomeros.getId(), true, productsRep);
        Products deltaForceBraket1 = Utils.setProduct("deltaForceBraket1", "description deltaForceBraket1", "descripción corta", 13000,4, brakets.getId(), true, productsRep);
        Products distalizador1 = Utils.setProduct("distalizador1", "description distalizador1", "descripción corta", 13000,4, distalizador.getId(), true, productsRep);
        Products distalizador2 = Utils.setProduct("distalizador2", "description distalizador2", "descripción corta", 13000,4, distalizador.getId(), true, productsRep);
        Products elastomeros1 = Utils.setProduct("elastomeros1", "description elastomeros1", "descripción corta", 13000,4, elastomeros.getId(), true, productsRep);
        Products elastomeros2 = Utils.setProduct("elastomeros2", "description elastomeros2", "descripción corta", 13000,4, elastomeros.getId(), true, productsRep);
        Products estandarBraket1 = Utils.setProduct("estandarBraket1", "description estandarBraket1", "descripción corta", 13000,4, brakets.getId(), true, productsRep);
        Products estandarBraket2 = Utils.setProduct("estandarBraket2", "description estandarBraket2", "descripción corta", 13000,4, brakets.getId(), true, productsRep);
        Products guantesLatex = Utils.setProduct("guantesLatex", "description guantesLatex", "descripción corta", 13000,4, desechables.getId(), true, productsRep);
        Products hojaBisturi1 = Utils.setProduct("hojaBisturi1", "description hojaBisturi1", "descripción corta", 13000,4, hojaBisturi.getId(), true, productsRep);
        Products hojaBisturi2 = Utils.setProduct("hojaBisturi2", "description hojaBisturi2", "descripción corta", 13000,4, hojaBisturi.getId(), true, productsRep);
        Products instrumentoOrtodoncia1 = Utils.setProduct("instrumentoOrtodoncia1", "description instrumentoOrtodoncia1", "descripción corta", 13000,4, instrumentosOrtodonticos.getId(), true, productsRep);
        Products instrumentoOrtodoncia2 = Utils.setProduct("instrumentoOrtodoncia2", "description instrumentoOrtodoncia2", "descripción corta", 13000,4, instrumentosOrtodonticos.getId(), true, productsRep);
        Products jeringa1 = Utils.setProduct("jeringa1", "description jeringa1", "descripción corta", 13000,4, jeringas.getId(), true, productsRep);
        Products jeringa2 = Utils.setProduct("jeringa2", "description jeringa2", "descripción corta", 13000,4, jeringas.getId(), true, productsRep);
        Products mango1 = Utils.setProduct("mango1", "description mango1", "descripción corta", 13000,4, mangoBisturi.getId(), true, productsRep);
        Products mango2 = Utils.setProduct("mango2", "description mango2", "descripción corta", 13000,4, mangoBisturi.getId(), true, productsRep);
        Products mBTBraket1 = Utils.setProduct("mBTBraket1", "description mBTBraket1", "descripción corta", 13000,4, mbt.getId(), true, productsRep);
        Products mBTBraket2 = Utils.setProduct("mBTBraket2", "description mBTBraket2", "descripción corta", 13000,4, mbt.getId(), true, productsRep);
        Products ortopedia1 = Utils.setProduct("ortopedia1", "description ortopedia1", "descripción corta", 13000,4, ortopedia.getId(), true, productsRep);
        Products ortopedia2 = Utils.setProduct("ortopedia2", "description ortopedia2", "descripción corta", 13000,4, ortopedia.getId(), true, productsRep);
        Products pinzaDental1 = Utils.setProduct("pinzaDental1", "description pinzaDental1", "descripción corta", 13000,4, pinzasDental.getId(), true, productsRep);
        Products pinzaDental2 = Utils.setProduct("pinzaDental2", "description pinzaDental2", "descripción corta", 13000,4, pinzasDental.getId(), true, productsRep);
        Products pinzaOrtodoncia1 = Utils.setProduct("pinzaOrtodoncia1", "description pinzaOrtodoncia1", "descripción corta", 13000,4, pinzasOrtodoncia.getId(), true, productsRep);
        Products pinzaOrtodoncia2 = Utils.setProduct("pinzaOrtodoncia2", "description pinzaOrtodoncia2", "descripción corta", 13000,4, pinzasOrtodoncia.getId(), true, productsRep);
        Products portaAguja1 = Utils.setProduct("portaAguja1", "description portaAguja1", "descripción corta", 13000,4, portaAgujas.getId(), true, productsRep);
        Products portaAguja2 = Utils.setProduct("portaAguja2", "description portaAguja2", "descripción corta", 13000,4, portaAgujas.getId(), true, productsRep);
        Products protectorCepillo = Utils.setProduct("protectorCepillo", "description protectorCepillo", "descripción corta", 13000,4, cuidadoDental.getId(), true, productsRep);
        Products provisional1 = Utils.setProduct("provicionales1", "description provicionales1", "descripción corta", 13000,4, provisionales.getId(), true, productsRep);
        Products provisional2 = Utils.setProduct("provicionales2", "description provicionales2", "descripción corta", 13000,4, provisionales.getId(), true, productsRep);
        Products rebase1 = Utils.setProduct("rebase1", "description rebase1", "descripción corta", 13000,4, rebases.getId(), true, productsRep);
        Products rebase2 = Utils.setProduct("rebase2", "description rebase2", "descripción corta", 13000,4, rebases.getId(), true, productsRep);
        Products reconstructor1 = Utils.setProduct("reconstructor1", "description reconstructor1", "descripción corta", 13000,4, reconstructor.getId(), true, productsRep);
        Products reconstructor2 = Utils.setProduct("reconstructor2", "description reconstructor2", "descripción corta", 13000,4, reconstructor.getId(), true, productsRep);
        Products resina1 = Utils.setProduct("resina1", "description resina1", "descripción corta", 13000,4, resinas.getId(), true, productsRep);
        Products resina2 = Utils.setProduct("resina2", "description resina2", "descripción corta", 13000,4, resinas.getId(), true, productsRep);
        Products rothBraket1 = Utils.setProduct("rothBraket1", "description rothBraket1", "descripción corta", 13000,4, roth.getId(), true, productsRep);
        Products rothBraket2 = Utils.setProduct("rothBraket2", "description rothBraket2", "descripción corta", 13000,4, roth.getId(), true, productsRep);
        Products tapaBocas1 = Utils.setProduct("tapabocas1", "description tapabocas1", "descripción corta", 13000,4, desechables.getId(), true, productsRep);
        Products tigera1 = Utils.setProduct("tigera1", "description tigera1", "descripción corta", 13000,4, tijeras.getId(), true, productsRep);
        Products tubo1 = Utils.setProduct("tubo1", "description tubo1", "descripción corta", 13000,4, tubos.getId(), true, productsRep);
        Products tubo2 = Utils.setProduct("tubo2", "description tubo2", "descripción corta", 13000,4, tubos.getId(), true, productsRep);
